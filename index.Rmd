...
install.packages(c("knitr", "geepack" ,"gt", "ggplot2", "tidyr", "dplyr", "car", "lavaan", "metafor", "lme4", "lmerTest", "stringr", "ggplot2", "DescTools", "corrplot")) 
```

```{r, message=FALSE, warning=FALSE}
library(knitr);library(geepack); library(gt); library(ggplot2); library(tidyr); library(dplyr);library(car);library(lavaan); library(metafor); library(kableExtra); library(gt);library(lme4);library(lmerTest); library(DescTools);library(stringr); library(corrplot)
```
